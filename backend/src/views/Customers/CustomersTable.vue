<template>
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
    ...
    <table class="table-auto w-full">
      ...
      <tbody v-else>
        <tr v-for="(customer, index) of customers.data" class="animate-fade-in"
                ...
                <MenuItems
                  ...
                  <div class="px-1 py-1">
                    ...
                    <button :class="[
                      ...
                      'group flex w-full items-center rounded-md px-2 py-2 text-sm']" @click="editCustomer(customer)">
                    ...
                    <button :class="[
                      active ? 'bg-indigo-600' : 'text-gray-900',
                      'group flex w-full items-center rounded-md px-2 py-2 text-sm']" @click="deleteCustomer(customer)">
