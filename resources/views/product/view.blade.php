    ...
    <div x-data="productItem({{ json_encode([
        ...
        <div class="grid gap-6 grid-cols-1 lg:grid-cols-5">
            ...
            <div class="lg:col-span-2">
                ...
                <button :disabled="product.quantity === 0" @click="addToCart($refs.quantityEl.value)" :class="product.quantity === 0 ? 'cursor-not-allowed' : 'cursor-pointer'" class="btn-primary py-4 text-lg flex justify-center min-w-0 w-full mb-6">
